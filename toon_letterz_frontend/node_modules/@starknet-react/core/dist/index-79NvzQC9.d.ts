import { AccountInterface, BlockNumber, ContractInterface, GetBlockResponse, Abi, ProviderInterface, Contract, CompiledContract, ContractFactory, Result, ArgsOrCalldata, Call, InvocationsDetails, InvokeFunctionResponse, RawArgs, BigNumberish, DeployContractResponse, TypedData, Signature, GetTransactionReceiptResponse, EstimateFeeResponse, EstimateFeeDetails } from 'starknet';
...
type UseBalanceProps = UseQueryProps<Balance, Error, Balance, ReturnType<typeof queryKey$8>> & {
...
declare function useBalance({ token, address, blockIdentifier, refetchInterval: refetchInterval_, watch, enabled: enabled_, ...props }: UseBalanceProps): UseQueryResult<{
    value: bigint;
    decimals: number;
    symbol: string;
    formatted: string;
}, Error>;
declare function queryKey$8({ chain, contract, token, address, blockIdentifier, }: {
    chain: Chain;
...
type UseBlockProps = UseQueryProps<GetBlockResponse, Error, GetBlockResponse, ReturnType<typeof queryKey$7>> & {
...
type UseBlockNumberProps = UseQueryProps<number, Error, number, ReturnType<typeof queryKey$6>> & {
    /** Identifier for the block to fetch. */
    blockIdentifier?: BlockNumber;
};
...
type UseContractReadProps = ContractReadArgs & UseQueryProps<Result, Error, Result, ReturnType<typeof queryKey$5>> & {
...
declare function queryKey$5({ chain, contract, functionName, args, blockIdentifier, }: {
    chain?: Chain;
    contract?: Contract;
...
type UseStarkAddressProps = UseQueryProps<string, Error, string, ReturnType<typeof queryKey$4>> & {
    /** Stark name. */
    name?: string;
...
declare function queryKey$4({ name, contract, network, }: {
    name?: string;
    contract?: string;
    network?: string;
}): readonly [{
...
type StarkNameArgs = UseQueryProps<string, unknown, string, ReturnType<typeof queryKey$3>> & {
    /** Account address. */
    address?: string;
    /** Naming contract to use . */
    contract?: string;
...
declare function queryKey$3({ address, contract, network, }: {
    address?: string;
    contract?: string;
    network?: string;
}): readonly [{
...
type UseWaitForTransactionProps = UseQueryProps<GetTransactionReceiptResponse, Error, GetTransactionReceiptResponse, ReturnType<typeof queryKey$2>> & {
...
declare function queryKey$2({ chain, hash }: {
    chain?: Chain;
    hash?: string;
}): readonly [{
...
type StarkProfileArgs = UseQueryProps<GetStarkprofileResponse, unknown, GetStarkprofileResponse, ReturnType<typeof queryKey$1>> & {
    /** Account address. */
    address?: string;
...
declare function queryKey$1({ address, namingContract, identityContract, }: {
    address?: string;
    namingContract?: string;
    identityContract?: string;
}): readonly [{
...
type UseEstimateFeesProps = EstimateFeesArgs & UseQueryProps<EstimateFeeResponse, Error, EstimateFeeResponse, ReturnType<typeof queryKey>> & {
    /** Refresh data at every block. */
    watch?: boolean;
};
